            ...
            .UseAsyncSeeding( async (context, _, ct) =>
            {
                ...
                if (!context.Set<Usuario>().Any())
                {
                    context.Set<Usuario>().AddRange(
                        new Usuario("Raimundo Jorge Danilo Nogueira", "raimundo-nogueira97@gmail.com", 10, null, ETipoUsuario.Aluno),
                        new Usuario("Miguel Geraldo João Castro", "miguel-castro96@inovasom.com", 20, new DateTime(1995, 10, 09), ETipoUsuario.Professor),
                        new Usuario("Silvana Flávia Ribeiro", "silvana-ribeiro89@yahoo.com.br", 15, null, ETipoUsuario.Visitante)
                    );
                }
                ...
                if (!context.Set<Funcionario>().Any())
                {
                    context.Set<Funcionario>().AddRange(
                        new Funcionario("SuperAdministrador", Environment.GetEnvironmentVariable("ADMIN_PASSWORD")!, "admin@admin.com.br", new DateTime(1993, 03, 19), ETipoFuncionario.SuperAdministrador)
                    );
                }
