...
namespace Biblioteca.Data.Migrations
{
    ...
    [Migration("20240910104549_addrenovado_emprestimo")]
    partial class addrenovado_emprestimo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Biblioteca.Domain.Entities.Emprestimo", b =>
                {
                    ...
                    b.ToTable("Emprestimo", "biblioteca", t =>
                        {
                            t.HasCheckConstraint("CK_DataFim_MaiorQue_DataInicio", "\"DataFim\" > \"DataInicio\"");
                        });
                });
